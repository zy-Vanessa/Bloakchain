...
if __name__ == '__main__':
    ...
    my_private_key = CBitcoinSecret('cP9oLiDuhM6vqCjAv2Rdqsqp4poGgfcqeXL4CvkJDZxY2Eq5v77o')

    my_public_key = my_private_key.pub
    my_address = P2PKHBitcoinAddress.from_pubkey(my_public_key)

    amount_to_send = 0.017 # amount of BTC in the output you're splitting minus fee
    txid_to_spend = (
        'fcaba9f986da666599ca3b1570605e0e1c8ef109cbd3031744a7532d2e8c1575')
    utxo_index = 0
